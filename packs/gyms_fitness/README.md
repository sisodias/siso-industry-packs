# Gyms, studios and independent fitness operators

`gyms_fitness` · **high** priority · business · status `queued`

**Client:** NM (Nick)

**Why:** Shaan named as a target vertical. No existing SISO base. | Nick (NM) has a gym/fitness business — likely first client for this vertical.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `gyms_fitness` → Copy research prompt.
