# US recruiting and staffing agencies

`recruiting_staffing` · **high** priority · business · status `queued`

**Why:** Shaan: recruiting is big money. Worth seeing what recruiting software is out there.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `recruiting_staffing` → Copy research prompt.
