# US mortgage brokerages

`mortgage_brokers` · **low** priority · business · status `queued`

**Why:** Shaan: big money but doesn't want to break into it.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `mortgage_brokers` → Copy research prompt.
