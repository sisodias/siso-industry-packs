...
`real_estate` · **medium** priority · business · status `queued`

**Why:** Shaan: we have a personal deal-sourcing project that could link up here. Property deal finding software.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `real_estate` → Copy research prompt.
