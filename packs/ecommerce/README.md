...
`ecommerce` · **medium** priority · business · status `queued`

**Why:** Live clients already: Lumelle (7 Shopify/Hydrogen repos), Home Essentials (1,550-product rebuild).


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `ecommerce` → Copy research prompt.
