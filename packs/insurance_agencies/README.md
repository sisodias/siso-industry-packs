# US independent insurance agencies

`insurance_agencies` · **medium** priority · business · status `queued`

**Why:** Shaan: doesn't know what insurance agencies actually do — research them properly. Company research first, then GitHub.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `insurance_agencies` → Copy research prompt.
