# US small construction contractors

`construction` · **medium** priority · business · status `queued`

**Why:** Shaan: we know people in construction but it's not high. Keep. Existing: clients/construction-rc (delivered 2026-01).


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `construction` → Copy research prompt.
