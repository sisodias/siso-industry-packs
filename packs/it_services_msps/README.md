# US small managed IT service providers

`it_services_msps` · **high** priority · business · status `queued`

**Why:** Shaan: IMPORTANT — this is what OUR agency should offer, and these firms are all about to be wiped out by AI. Research what the big public/private IT services firms offer; that defines our own product surface.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `it_services_msps` → Copy research prompt.
