# Aircraft parts distribution & AOG sourcing

`aviation_parts_distribution` · **high** priority · business · status `queued`

**Why:** Live client lead: aircraftpartseurope.com (APE). Shopify storefront, 80k-100k part numbers, RFQ builder, New/Overhauled/Serviceable conditions, traceability docs, AOG support, global supplier sourcing network.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `aviation_parts_distribution` → Copy research prompt.
