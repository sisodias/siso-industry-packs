# US adult vocational and continuing-education providers

`education_training` · **low** priority · business · status `queued`

**Why:** Shaan: doesn't know what this means. Keep on the list but low.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `education_training` → Copy research prompt.
