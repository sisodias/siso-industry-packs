...
`law_firms` · **high** priority · business · status `queued`

**Why:** Shaan: every business needs a law firm. Worth seeing what OSS exists. Horizontal leverage.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `law_firms` → Copy research prompt.
