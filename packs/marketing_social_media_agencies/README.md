# US marketing and social-media agencies

`marketing_social_media_agencies` · **high** priority · business · status `queued`

**Why:** Shaan: every business needs marketing — research the whole code workflow. Also our own peer group.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `marketing_social_media_agencies` → Copy research prompt.
