# US residential property managers

`property_management` · **low** priority · business · status `queued`

**Why:** Shaan: have a look, don't really want to break into it, but might need to eventually.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `property_management` → Copy research prompt.
