# US small hotels and lodging operators

`hospitality` · **medium** priority · business · status `queued`

**Why:** Shaan: one of my boys wants to get into hospitality — have a look.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `hospitality` → Copy research prompt.
