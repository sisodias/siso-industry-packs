# Community owners and paid-community operators

`community_owners` · **medium** priority · business · status `queued`

**Why:** Shaan renamed course_creators -> community_owners. The real target is people who SELL AND RUN A COMMUNITY (Skool-style, subscription), who also happen to make courses. Custom community platforms, not course hosting.


## Run the research

Prompt: **https://siso-superapp-forge.pages.dev** → find `community_owners` → Copy research prompt.
